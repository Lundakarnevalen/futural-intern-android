...
public class CountdownFragment extends LKFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		karneVal = new GregorianCalendar(2014, 3, 5, 19, 7, 30).getTime();

		karneLan = new GregorianCalendar(2014, 3, 5, 19, 7, 0).getTime();
		// TODO Change time here before release
		// karneLan = new GregorianCalendar(2014, 3, 16, 18, 0, 0).getTime();
		preKarneval = new GregorianCalendar(2014, 3, 5, 19, 7, 20).getTime();
		karneBeer = new GregorianCalendar(2014, 3, 5, 19, 7, 10).getTime();
		postKarneval = new GregorianCalendar(2014, 3, 5, 19, 7, 40).getTime();
