...
public class UserWrite {
	...
	public String gcmRegId, engagerad_studentikos, engagerad_etc, created_at, updated_at, ovrigt;
	public int kon_id, nation_id, storlek_id, terminer, korkort_id, snalla_intresse, snalla_sektion;
