...
public class User {
	...
	public String engagerad_studentikos, engagerad_etc, created_at, updated_at, ovrigt;
	public int id, kon_id, nation_id, storlek_id, terminer, korkort_id, snalla_intresse, snalla_sektion;
