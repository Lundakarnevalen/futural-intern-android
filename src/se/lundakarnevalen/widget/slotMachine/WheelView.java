...
public class WheelView extends View {
	...
	private static final int[] SHADOW_COLORS = new int[] { 0xAAE6E6E6,
			0x00FFFFFF, 0x00E6E6E6 }; // The first is the one in the edges. The
										// first two symbols is how transparent
										// it shall be.
