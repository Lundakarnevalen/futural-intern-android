...
//		String[] dataProjection = {SectionSQLiteDBContract.COLUMN_NAME_ENTRY_ID, SectionSQLiteDBContract.COLUMN_NAME_TITLE, SectionSQLiteDBContract.COLUMN_NAME_ICON, SectionSQLiteDBContract.COLUMN_NAME_INFO, SectionSQLiteDBContract.COLUMN_NAME_LIKED};
		String[] dataProjection = {SectionSQLiteDBContract.COLUMN_NAME_ENTRY_ID, SectionSQLiteDBContract.COLUMN_NAME_TITLE, SectionSQLiteDBContract.COLUMN_NAME_INFO, SectionSQLiteDBContract.COLUMN_NAME_LIKED};
		...
		while(!cursor.isAfterLast()){
			LKSectionsItem item = new LKSectionsItem(cursor.getString(1), cursor.getString(2), Boolean.getBoolean(cursor.getString(3)));
